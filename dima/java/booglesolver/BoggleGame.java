...
/******************************************************************************
 *  Compilation:  javac dima.java.booglesolver.BoggleGame.java
 *  Execution:    java dima.java.booglesolver.BoggleGame [m n]
 *  Dependencies: dima.java.booglesolver.BoggleSolver.java BoggleBoard.java
 ...
 *
 *  % javac dima.java.booglesolver.BoggleGame.java
 *  
 *  % java dima.java.booglesolver.BoggleGame
 *
 *  % java -Xmx300m dima.java.booglesolver.BoggleGame 3 7
 *  
            ...
            public void run() {
                ...
                if (args.length == 0) {
                    ...
                    try {
                        ...
                        System.err.println("Usage: java dima.java.booglesolver.BoggleGame " +
                                           "\nor:    java dima.java.booglesolver.BoggleGame [rows]" +
                                           "\nor:    java dima.java.booglesolver.BoggleGame [rows] [cols]");
                        System.exit(1);
                    }
                }
                ...
                if (rows <= 0 || cols <= 0) {
                    throw new java.lang.IllegalArgumentException("Rows and columns must be positive" + 
                                                                 "\nUsage: java dima.java.booglesolver.BoggleGame " +
                                                                 "\nor:    java dima.java.booglesolver.BoggleGame [rows]" +
                                                                 "\nor:    java dima.java.booglesolver.BoggleGame [rows] [cols]");
                }
